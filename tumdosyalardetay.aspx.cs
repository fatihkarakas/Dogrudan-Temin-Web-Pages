...
public partial class yonetim_tumdosyalardetay : System.Web.UI.Page
{
    ...
    public bool kt(int id)
    {
        ...
        try
        {
            ...
            sorgu.CommandText = "select Count(*) as say from zihale_icerik where ihale_id =" + id + " and Sonuc <> 9 ";
