<%@ Page Title="" Language="C#" MasterPageFile="~/tema.master" AutoEventWireup="true" CodeFile="onaylanmislar.aspx.cs" Inherits="onaylanmislar" ValidateRequest="false" %>
                            ...
                            <div class="box-body no-padding">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='onaylamisdetay.aspx?id=<%#Eval("id")%>' class="btn btn-success">Alım Dosya Detayı</a>
                                           </td>
                                    </tr>
