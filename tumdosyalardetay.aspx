<%@ Page Title="" Language="C#" MasterPageFile="~/tema.master" AutoEventWireup="true" CodeFile="tumdosyalardetay.aspx.cs" Inherits="yonetim_tumdosyalardetay" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <section class="content-header">
        <h1>TUM DOSYALAR DETAY</h1>
                            ...
                            <div class="box-body no-padding">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td><b>Dosya Açıklama</b> </td>
                                        <td colspan="3"> <asp:TextBox runat="server" ID="comment1" Text='<%# DataBinder.Eval(Container.DataItem,"comment")  %>'  TextMode="MultiLine" CssClass="form-control text-danger"></asp:TextBox></td>
