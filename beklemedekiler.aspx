<%@ Page Title="" Language="C#" MasterPageFile="~/tema.master" AutoEventWireup="true" CodeFile="Beklemedekiler.aspx.cs" Inherits="Beklemedekiler" %>
                            ...
                            <div class="box-body no-padding">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='beklemedekilerdetay.aspx?id=<%#Eval("id")%>' class="btn btn-success">Alım Dosya Detayı</a>
                                           </td>
                                    </tr>
