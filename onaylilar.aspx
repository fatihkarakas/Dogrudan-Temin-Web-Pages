<%@ Page Title="" Language="C#" MasterPageFile="~/tema.master" AutoEventWireup="true" CodeFile="onaylilar.aspx.cs" Inherits="onaylılar" ValidateRequest="false" %>
                            ...
                            <div class="box-body no-padding">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href='tamamlanmislar.aspx?id=<%#Eval("id")%>' class="btn btn-success">Alım Dosya Detayı</a>
                                           </td>
                                    </tr>
