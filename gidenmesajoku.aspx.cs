...
public partial class yonetim_gidenmesajoku : System.Web.UI.Page
{
    ...
    public void mesajgetir(int id)
    {
        try
        {
            ...
            sorgu.CommandText = "select * from zih_gidenmesaj where mgid = " + id + "";
            oku = sorgu.ExecuteReader();
            while (oku.Read())
            {
                kimden = oku["kime_isimler"].ToString();
